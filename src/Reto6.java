...
public class Reto6 {
    public static void main(String[] args) {
        int cantidad=0,precio=0,subtotal=0,compra=0,juego,descuento=0,pago=0,montototal;
        String respuesta="si";
        ...
        do{
            ...
            if(subtotal>=0){
                ...
                if (compra>50000){
                    System.out.println("felicidades puede aacder al descuento");
                    ...
                    switch(juego){
                        ...
                        pago=leer.nextInt();
                        pago=pago-descuento;
                        System.out.println("su cambkio es de "+pago);
                        break;
                        ...
                        case 4:
                        System.out.println("felicidades llevas tu compra gratis");
                        break;
                    }
                }   leer.close();
    }
